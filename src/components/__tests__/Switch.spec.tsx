...
test('Switch component renders without any props', () => {
  ...
  expect(
    wrap.containsMatchingElement(
      <button className=" toggle-btn toggle-btn-off" />
    )
  ).toBeTruthy()
})

test("Switch component renders different buttons according to 'on' props", () => {
  const wrap = shallow(<Switch />)
...
test('Switch component invokes onClick function', () => {
